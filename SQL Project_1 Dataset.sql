...
(31, 'Ryan Cooper', 'Male', '1999-03-10', '2025-06-01', 3, 'Trainee Engineer', 58000, 5),
(32, 'Ava Singh', 'Female', '2000-07-22', '2025-09-15', 8, 'Junior Data Analyst', 60000, 15),
-- These 3 employees below are added with dynamic hire dates using CURRENT_DATE - INTERVAL
-- so their tenure is always less than 2 years.
-- This ensures Query 1 (employees with tenure < 2 years) always returns results
-- without needing manual date updates in the future.
(33, 'Riyan', 'Male', '1997-07-18', CURRENT_DATE - INTERVAL '6 months', 3, 'Intern Engineer', 55000, 5),
(34, 'Jethalal', 'Male', '1998-11-11', CURRENT_DATE - INTERVAL '1 year', 3, 'Graduate Engineer', 60000, 5),
(35, 'Champaklal', 'Male', '1996-02-13', CURRENT_DATE - INTERVAL '18 months', 7, 'Operations Coordinator', 68000, 18);
